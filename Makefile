...
OBJECTS += ./mbed-os/components/TARGET_PSA/services/psa_prot_internal_storage/COMPONENT_PSA_SRV_EMUL/psa_prot_internal_storage.o
OBJECTS += ./mbed-os/components/TARGET_PSA/services/psa_prot_internal_storage/COMPONENT_PSA_SRV_IMPL/pits_impl.o
# OBJECTS += ./mbed-os/components/storage/blockdevice/COMPONENT_FLASHIAP/FlashIAPBlockDevice.o
OBJECTS += ./mbed-os/components/storage/blockdevice/COMPONENT_FLASHIAP/util/fslittle_test.o
OBJECTS += ./mbed-os/components/storage/blockdevice/COMPONENT_SD/SDBlockDevice.o
OBJECTS += ./mbed-os/components/storage/blockdevice/COMPONENT_SD/util/fsfat_test.o
...
OBJECTS += ./mbed-os/features/mbedtls/mbed-crypto/platform/TARGET_PSA/COMPONENT_PSA_SRV_IMPL/psa_crypto.o
OBJECTS += ./mbed-os/features/mbedtls/mbed-crypto/platform/TARGET_PSA/COMPONENT_PSA_SRV_IMPL/psa_crypto_storage.o
OBJECTS += ./mbed-os/features/mbedtls/mbed-crypto/platform/TARGET_PSA/COMPONENT_PSA_SRV_IMPL/psa_crypto_storage_file.o
OBJECTS += ./mbed-os/features/mbedtls/mbed-crypto/platform/TARGET_PSA/COMPONENT_PSA_SRV_IMPL/psa_crypto_storage_its.o
...
OBJECTS += ./mbed-os/features/netsocket/cellular/cellular_driver_l3ip.o
...
INCLUDE_PATHS += -I.././mbed-os/components/TARGET_PSA/services/crypto
INCLUDE_PATHS += -I.././mbed-os/components/TARGET_PSA/services/psa_prot_internal_storage
INCLUDE_PATHS += -I.././mbed-os/components/TARGET_PSA/services/psa_prot_internal_storage/COMPONENT_PSA_SRV_IMPL
INCLUDE_PATHS += -I.././mbed-os/components/TARGET_PSA/spm
INCLUDE_PATHS += -I.././mbed-os/components/storage/blockdevice/COMPONENT_FLASHIAP
INCLUDE_PATHS += -I.././mbed-os/components/storage/blockdevice/COMPONENT_FLASHIAP/util
INCLUDE_PATHS += -I.././mbed-os/components/storage/blockdevice/COMPONENT_SD
INCLUDE_PATHS += -I.././mbed-os/components/storage/blockdevice/COMPONENT_SD/util
...
INCLUDE_PATHS += -I.././mbed-os/features/mbedtls/mbed-crypto/platform/TARGET_PSA/COMPONENT_PSA_SRV_IMPL
INCLUDE_PATHS += -I.././mbed-os/features/mbedtls/mbed-crypto/platform/TARGET_PSA/COMPONENT_PSA_SRV_IMPL/COMPONENT_NSPE
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1546708292.32
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1546708292.32
...
ASM_FLAGS += -I.././mbed-os/components/TARGET_PSA/services/crypto
ASM_FLAGS += -I.././mbed-os/components/TARGET_PSA/services/psa_prot_internal_storage
ASM_FLAGS += -I.././mbed-os/components/TARGET_PSA/services/psa_prot_internal_storage/COMPONENT_PSA_SRV_IMPL
ASM_FLAGS += -I.././mbed-os/components/TARGET_PSA/spm
ASM_FLAGS += -I.././mbed-os/components/storage/blockdevice/COMPONENT_FLASHIAP
ASM_FLAGS += -I.././mbed-os/components/storage/blockdevice/COMPONENT_FLASHIAP/util
ASM_FLAGS += -I.././mbed-os/components/storage/blockdevice/COMPONENT_SD
ASM_FLAGS += -I.././mbed-os/components/storage/blockdevice/COMPONENT_SD/util
...
ASM_FLAGS += -I.././mbed-os/features/mbedtls/mbed-crypto/platform/TARGET_PSA/COMPONENT_PSA_SRV_IMPL
ASM_FLAGS += -I.././mbed-os/features/mbedtls/mbed-crypto/platform/TARGET_PSA/COMPONENT_PSA_SRV_IMPL/COMPONENT_NSPE
